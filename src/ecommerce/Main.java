...
public class Main {
    public static void main(String[] args) {
        ...
        // 1. 初始化平台商品資料庫
        system.getProducts().add(new Product("P01", "MacBook Pro 14\"", 60000, 10));
        system.getProducts().add(new Product("P02", "無線藍牙滑鼠", 900, 50));
        system.getProducts().add(new Product("P03", "機械式鍵盤", 2500, 20));
